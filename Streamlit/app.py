...
Page_Views = st.slider("Views", min_value=50, max_value=5000000)
Clicks = st.slider("Clicks", min_value=10, max_value=1000000)
Signups = st.slider("Signups", min_value=1, max_value=2000000)
